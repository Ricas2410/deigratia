...
# from users.models import CustomUser, Parent  # Using string references instead
...
class Appointment(models.Model):
    ...
    parent = models.ForeignKey('users.Parent', on_delete=models.CASCADE, related_name='appointments')
